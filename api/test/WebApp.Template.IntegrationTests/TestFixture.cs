/*
 This file is copied from FastEndpoints library and modified to fit the needs of this project.
 The cache is removed so every test class has its unique instance of the test fixture.
*/ 
...
public abstract class TestFixture<TProgram> : BaseFixture, IAsyncLifetime, IFixture where TProgram : class
{
    ...
    void Initialize(IMessageSink? s = null, ITestOutputHelper? h = null)
    {
        _app = (WebApplicationFactory<TProgram>)
            WafInitializer(typeof(TProgram));
